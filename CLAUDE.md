...
- `web.py` — Web UI (~2600 lignes) : HTTP server, SPA HTML/JS embarquee, thread-safe state wrapper, 28 endpoints API, Findings panel, 5 accordion tabs + AID Scan/Fuzz popups. Always on: Hack Color, ABEND Detection, Transaction Tracking.
